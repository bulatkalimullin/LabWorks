...
router.register(r'deadline-overrides', api_views.DeadlineOverrideViewSet, basename='deadline-override')
...
urlpatterns = [
    ...
    path('public/settings/', api_views.public_settings, name='api-public-settings'),
    path('auth/me/', api_views.me, name='api-me'),
    path('auth/sync/', api_views.session_check, name='api-session-check'),
    path('auth/profile/', api_views.profile_update, name='api-profile-update'),
    ...
    path('admin/settings/', api_views.admin_settings, name='api-admin-settings'),
